...
; API configuration
apiModel := "gpt-5-mini"   ; reasoning model (supports reasoning parameters, no temperature)
Verbosity := "low"         ; concise output per Responses API text config
reasoningEffort := "minimal"   ; minimal = fastest for gpt-5-mini (unique to this model), also supports low/medium/high
